...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE( DAM_APPLICATION, double, CRITICAL_DISPLACEMENT_TANGENT)
    KRATOS_DEFINE_APPLICATION_VARIABLE( DAM_APPLICATION, double, YIELD_STRESS_TANGENT )

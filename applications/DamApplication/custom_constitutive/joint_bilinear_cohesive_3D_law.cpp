...
void JointBilinearCohesive3DLaw::GetLawFeatures(Features& rFeatures)
{
    //Set the type of law
...
int JointBilinearCohesive3DLaw::Check(const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const ProcessInfo& rCurrentProcessInfo) const
{
...
void JointBilinearCohesive3DLaw::InitializeMaterial( const Properties& rMaterialProperties,const GeometryType& rElementGeometry,const Vector& rShapeFunctionsValues )
{
...
void JointBilinearCohesive3DLaw::CalculateMaterialResponseCauchy (Parameters& rValues)
{
    //Check
...
void JointBilinearCohesive3DLaw::FinalizeMaterialResponseCauchy (Parameters& rValues)
{
...
double& JointBilinearCohesive3DLaw::GetValue( const Variable<double>& rThisVariable, double& rValue )
{
...
void JointBilinearCohesive3DLaw::SetValue( const Variable<double>& rThisVariable, const double& rValue,
...
void JointBilinearCohesive3DLaw::InitializeConstitutiveLawVariables(ConstitutiveLawVariables& rVariables,
                                                                Parameters& rValues)

{
    ...
    rVariables.CriticalDisplacementTangent = MaterialProperties[CRITICAL_DISPLACEMENT_TANGENT];
    rVariables.DamageThreshold = MaterialProperties[DAMAGE_THRESHOLD];
    rVariables.YieldStress = MaterialProperties[YIELD_STRESS];
    rVariables.YieldStressTangent = MaterialProperties[YIELD_STRESS_TANGENT];
...
void JointBilinearCohesive3DLaw::ComputeEquivalentStrain(ConstitutiveLawVariables& rVariables,
                                                    Parameters& rValues)
{
...
void JointBilinearCohesive3DLaw::CheckLoadingFunction(ConstitutiveLawVariables& rVariables,
                                                    Parameters& rValues)
{
...
void JointBilinearCohesive3DLaw::ComputeConstitutiveMatrix(Matrix& rConstitutiveMatrix,
...
void JointBilinearCohesive3DLaw::ComputeStressVector(Vector& rStressVector,
                                                ConstitutiveLawVariables& rVariables,
                                                Parameters& rValues)
{
    const Vector& StrainVector = rValues.GetStrainVector();

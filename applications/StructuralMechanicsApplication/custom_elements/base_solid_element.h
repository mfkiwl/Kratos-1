...
private:
     ...
     */
    void RotateToLocalAxes(ConstitutiveLaw::Parameters &rValues, const KinematicVariables& rThisKinematicVariables, const IndexType PointNumber, const ConstitutiveLaw::StressMeasure ThisStressMeasure);
     ...
     * @param rValues The constitutive laws parameters
     */
    void RotateToGlobalAxes(ConstitutiveLaw::Parameters &rValues, const KinematicVariables& rThisKinematicVariables);
